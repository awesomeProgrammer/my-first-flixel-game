...
Void FlxGame_obj::create( Dynamic _){
{
		...
		HX_STACK_LINE(310)
		{
			...
			if (((bool(this->_skipSplash) || bool((::flixel::system::FlxSplash_obj::nextState != null()))))){
				HX_STACK_LINE(310)
				::flixel::FlxState _g5 = ::Type_obj::createInstance(this->_initialState,Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(_g5,"_g5");
				HX_STACK_LINE(310)
				...
				HX_STACK_LINE(310)
				::flixel::system::FlxSplash _g6 = ::flixel::system::FlxSplash_obj::__new(null());		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(310)
				this->_requestedState = _g6;
				HX_STACK_LINE(310)
				this->_skipSplash = true;
			}
			HX_STACK_LINE(310)
		...
		this->switchState();
		HX_STACK_LINE(313)
		int _g7 = ::Std_obj::_int((Float((int)1000) / Float(::flixel::FlxG_obj::game->_stepMS)));		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(313)
		if (((_g7 < ::flixel::FlxG_obj::drawFramerate))){
			HX_STACK_LINE(315)
		...
		HX_STACK_LINE(326)
		int _g8 = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageWidth();		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(326)
		int _g9 = ::openfl::_v2::Lib_obj::get_current()->get_stage()->get_stageHeight();		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(326)
		this->resizeGame(_g8,_g9);
	}
return null();
}
