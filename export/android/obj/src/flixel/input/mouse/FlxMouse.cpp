...
HX_STACK_ARG(CursorContainer,"CursorContainer")
{
	...
	HX_STACK_LINE(440)
	::openfl::_v2::display::Stage _g3 = ::openfl::_v2::Lib_obj::get_current()->get_stage();		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(440)
	this->_stage = _g3;
	HX_STACK_LINE(441)
...
Void FlxMouse_obj::destroy( ){
{
		...
		HX_STACK_LINE(395)
		::openfl::_v2::display::BitmapData _g5 = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_cursorBitmapData);		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(395)
...
Void FlxMouse_obj::onMouseLeave( ::openfl::_v2::events::Event E){
{
