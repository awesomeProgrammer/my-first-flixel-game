...
{
HX_STACK_FRAME("Coin","new",0x704aaf23,"Coin.new","Coin.hx",16,0x01a6c5ad)
HX_STACK_THIS(this)
...
Void Coin_obj::kill( ){
{
		HX_STACK_FRAME("Coin","kill",0xcf15eb7b,"Coin.kill","Coin.hx",26,0x01a6c5ad)
		HX_STACK_THIS(this)
		HX_STACK_LINE(27)
		this->set_alive(false);
		struct _Function_1_1{
			inline static Dynamic Block( hx::ObjectPtr< ::Coin_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","Coin.hx",30,0x01a6c5ad)
				{
...
{
		HX_STACK_FRAME("Coin","finishKill",0x3e72412e,"Coin.finishKill","Coin.hx",41,0x01a6c5ad)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_,"_")
		HX_STACK_LINE(41)
