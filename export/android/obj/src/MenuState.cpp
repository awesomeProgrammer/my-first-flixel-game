...
{
		HX_STACK_FRAME("MenuState","clickPlay",0x5f6a9ec0,"MenuState.clickPlay","MenuState.hx",26,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(26)
...
{
		HX_STACK_FRAME("MenuState","create",0xe57b7c18,"MenuState.create","MenuState.hx",33,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(35)
...
{
		HX_STACK_FRAME("MenuState","destroy",0xf9ac905e,"MenuState.destroy","MenuState.hx",48,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(49)
		this->super::destroy();
		HX_STACK_LINE(51)
...
{
		HX_STACK_FRAME("MenuState","update",0xf0719b25,"MenuState.update","MenuState.hx",59,0xdfbcb22c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(59)
		this->super::update();
	}
